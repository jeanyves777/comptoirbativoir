  ...
  return (
    ...
    >
      <style>{`
        ...
        .about-light-amber { animation: blink-amber 2.5s infinite; }
        .about-gear-1 {
      ...
      <defs>
        <pattern id="about-grid" width="20" height="20" patternUnits="userSpaceOnUse">
          <path d="M 20 0 L 0 0 0 20" fill="none" className="stroke-amber-500/20 dark:stroke-amber-500/10" strokeWidth="0.15" />
        </pattern>
      </defs>
      ...
      <g className="about-gear-1">
        <circle cx="440" cy="80" r="30" fill="none" className="stroke-amber-500/20 dark:stroke-blue-500/25" strokeWidth="2" />
        {[0, 45, 90, 135, 180, 225, 270, 315].map((angle) => (
          <rect
            ...
            height="14"
            rx="2"
            className="fill-amber-500/20 dark:fill-blue-500/25"
      ...
      <g className="about-gear-2">
        <circle cx="60" cy="350" r="22" fill="none" className="stroke-amber-500/15 dark:stroke-amber-500/20" strokeWidth="1.5" />
        {[0, 60, 120, 180, 240, 300].map((angle) => (
          <rect
            ...
            height="10"
            rx="1.5"
            className="fill-amber-500/15 dark:fill-amber-500/20"
      ...
      <circle cx="215" cy="180" r="5" className="about-light-amber" />
      ...
      <circle cx="295" cy="180" r="5" className="about-light-amber" />
      ...
      <rect x="255" y="260" width="50" height="30" rx="3" className="fill-neutral-200 dark:fill-slate-900" stroke="#f59e0b" strokeWidth="1" />
  ...
  return (
    <div ref={ref} className="mb-5">
      <div className="flex justify-between mb-1.5">
        ...
        <span className="text-sm font-semibold text-amber-600 dark:text-amber-400">{value}%</span>
      </div>
  ...
  return (
    ...
    >
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block px-4 py-1.5 bg-amber-50 text-amber-600 border border-amber-200 dark:bg-amber-500/10 dark:text-amber-400 dark:border-amber-500/30 rounded-full text-sm font-medium mb-4">
            Qui sommes-nous
          </span>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-amber-50 text-amber-600 dark:bg-amber-500/10 dark:text-amber-400 flex items-center justify-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative bg-neutral-50 border border-neutral-200 dark:bg-neutral-900 dark:border-neutral-800 rounded-2xl p-6">
              <WorkersSVG />
            </div>
          </motion.div>
        </div>
